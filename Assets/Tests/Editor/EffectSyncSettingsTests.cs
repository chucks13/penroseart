...
public sealed class EffectSyncSettingsTests
{
    ...
    /// Defaults, including the picture-shaping values dual-homed on both mode surfaces.
    /// </summary>
    [Test]
    ...
    public void RestoreSyncDefaultsCopiesEveryFlockValue()
    {
        ...
        asset.Settings.MaximumFillLeadBeats = 41f;
        ...
        Assert.That(asset.Settings.MaximumFillLeadBeats, Is.EqualTo(defaults.MaximumFillLeadBeats));
        ...
        Assert.That(asset.Settings.DropReleaseBeats, Is.EqualTo(defaults.DropReleaseBeats));
