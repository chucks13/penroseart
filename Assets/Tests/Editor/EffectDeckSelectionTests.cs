...
public sealed class TransitionDeckSelectionTests
{
    ...
    [Test]
    public void TryPullPreferredPullsMatchingDropTransitionAndRotatesDeck()
    {
        var deck = new[] { 1, 2, 0 };

        var found = TransitionDeckSelection.TryPullPreferred(
            deck,
            Repertoire.HandlesDrop,
            transitionIndex => transitionIndex == 2 ? RepertoireFor(Repertoire.HandlesDrop) : RepertoireFor(Repertoire.None),
            _ => true,
    ...
    [Test]
    public void TryPullPreferredPullsMatchingFillTransitionAndRotatesDeck()
    {
        var deck = new[] { 1, 2, 0 };
        ...
        var found = TransitionDeckSelection.TryPullPreferred(
            ...
            transitionIndex => transitionIndex == 1 ? RepertoireFor(Repertoire.HandlesFill) : RepertoireFor(Repertoire.None),
            _ => true,
            out var selected);
    ...
    [Test]
    public void TryPullPreferredLeavesDeckWhenMatchingTagIsAbsent()
    {
        var deck = new[] { 1, 2, 0 };
        ...
        var found = TransitionDeckSelection.TryPullPreferred(
            deck,
            Repertoire.HandlesDrop,
            _ => RepertoireFor(Repertoire.None),
            _ => true,
            out var selected);
    ...
    [Test]
    public void TryPullPreferredLeavesDeckWhenTimingShapeCannotServeCue()
    {
        var deck = new[] { 1, 2, 0 };
        ...
        var found = TransitionDeckSelection.TryPullPreferred(
            deck,
            Repertoire.HandlesDrop,
            _ => RepertoireFor(Repertoire.HandlesDrop),
            _ => false,
            out var selected);
    ...
    [Test]
    public void TryPullPreferredDoesNotTreatTimingOnlySuitabilityAsEventCapable()
    {
        var deck = new[] { 1, 2, 0 };
