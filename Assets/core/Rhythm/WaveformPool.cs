...
public static class WaveformPool
{
    ...
    public struct Entry
    {
        /// <summary>The human/editor display name used by exact runtime acquisition.</summary>
        public string name;
    ...
    private const string CanonicalHeader =
        ...
        "// the whole Pool, or by the first exact name match; no performer stores a row index. A missing\n" +
        "// selected name fails visibly at the next acquisition.\n" +
        "\n";
