...
/// on the editor's idle tick, so live dashboards such as <see cref="BeatDataDrawer"/> animate in coarse steps.
...
/// Waveform Pool editor lives in the <see cref="BeatDataDrawer"/> panel, right beside the live dashboard.
/// </remarks>
