...
_Avoid_: index addressing in any form (a Pool position may change at any time; names are the stable handle); a second evaluation spelling on the provider; "Wall Variant Lock" (retired name — see **Waveform Hold**).
