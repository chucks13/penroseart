...
| Cue/casting | `Assets/core/Switching/SyncedCueIntent.cs`, `Assets/core/Transitions/TransitionBeatPlan.cs`, `Assets/core/Switching/Deck.cs`, `Assets/core/Effects/Repertoire.cs` | Classify Cue Marks as ordinary/Fill/Drop intent, decide whether a Synced cue command should fire, and choose event-capable Effects/Transitions. |
